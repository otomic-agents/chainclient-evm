...
export default class EventFilter {
    ...
    constructor(_monitor: Monitor){
        ...
        const dispatcher = async () => {
            ...
            if (self.monitor.blockFetchTaskList == undefined) throw new Error("blockFetchTaskList undefined");
                ...
                events.forEach(async (log: any) => {
                    ...
                    { 
                        ...
                        self.monitor.evmRpcClient.get().request({
                            ...
                            console.log('call eth_getBlockByNumber error', log.transactionHash)
