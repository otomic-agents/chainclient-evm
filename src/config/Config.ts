...
export default {
    ...
    evm_config : {
        ...
        refunded_in         : {
            topic_string    : "0x07f8df3bbdbe59fd10ed498020d467a29c15bb577478cc7c0bae7f03ba5c03bc",
            event_data      : OBridgeABI.abi.filter(item => item.name == "LogTransferInRefunded" && item.type == "event")[0]            
        },
        submit_complaint    : {
            topic_string    : "0x8a61788ae4d620cc72d8f0552fb85e5ce5a4be697a3b62a4a63642040e05a46d",
