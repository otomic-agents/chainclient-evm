...
import { CommandTransferConfirm, CommandTransferIn, CommandTransferRefund, EvmConfig, GasInfo, KoaCtx, TransactionRequestCC } from '../interface/interface'
...
const buildTransferIn = async (ctx: KoaCtx, command_transfer_in: CommandTransferIn, gas: GasInfo, obridgeIface: ethers.utils.Interface): Promise<TransactionRequestCC> => {
