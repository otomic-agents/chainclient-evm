...
const createCallback = (url: string, type: string, config: EvmConfig, merge: boolean, mergeData: Function) => {
...
export const watchTransferOut = (monitor: Monitor, url: string, config: EvmConfig, merge: boolean, mergeData: Function) => {
    ...
    monitor.watch(filter_info, createCallback(url, "TransferOut", config, merge, mergeData), {
        "TransferOut": url,
...
export const watchTransferIn = (monitor: Monitor, url: string, config: EvmConfig, merge: boolean, mergeData: Function) => {
    ...
    monitor.watch(filter_info, createCallback(url, "TransferIn", config, merge, mergeData), {
        "TransferIn": url,
...
export const watchConfirmOut = (monitor: Monitor, url: string, config: EvmConfig, merge: boolean, mergeData: Function) => {
    ...
    monitor.watch(filter_info, createCallback(url, "ConfirmOut", config, merge, mergeData), {
        "Confirm": url,
        TransferOut: undefined,
        TransferIn: undefined,
        Refund: undefined,
...
export const watchConfirmIn = (monitor: Monitor, url: string, config: EvmConfig, merge: boolean, mergeData: Function) => {
    ...
    monitor.watch(filter_info, createCallback(url, "ConfirmIn", config, merge, mergeData), {
        "Confirm": url,
        TransferOut: undefined,
        TransferIn: undefined,
        Refund: undefined,
...
export const watchRefundOut = (monitor: Monitor, url: string, config: EvmConfig, merge: boolean, mergeData: Function) => {
    ...
    monitor.watch(filter_info, createCallback(url, "RefundOut", config, merge, mergeData), {
        "Refund": url,
        TransferOut: undefined,
        TransferIn: undefined,
        Confirm: undefined,
...
export const watchRefundIn = (monitor: Monitor, url: string, config: EvmConfig, merge: boolean, mergeData: Function) => {
    ...
    monitor.watch(filter_info, createCallback(url, "RefundIn", config, merge, mergeData), {
        "Refund": url,
        TransferOut: undefined,
        TransferIn: undefined,
        Confirm: undefined,
...
export const watchReputation = (monitor: Monitor, url: string, config: EvmConfig, merge: boolean, mergeData: Function) => {
    ...
    monitor.watch(filter_info, createCallback(url, "Reputation", config, merge, mergeData), {
        "Reputation": url,
        TransferOut: undefined,
        TransferIn: undefined,
        Confirm: undefined,
